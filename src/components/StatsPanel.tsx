    ...
    <div style={{ marginTop: 24, paddingTop: 20, borderTop: "1px solid #2a2a3e" }}>
      ...
      >
        <div style={{ flex: 1, textAlign: "center" }}>
          ...
          <div style={{ fontSize: 12, color: "#888", marginTop: 2 }}>🔥 今日起身</div>
        </div>
        <div style={{ flex: 1, textAlign: "center" }}>
          <div style={{ fontSize: 22, fontWeight: 700, color: "#4caf50" }}>
            {stats.streak_days}
          </div>
          <div style={{ fontSize: 12, color: "#888", marginTop: 2 }}>⭐ 连续达标</div>
        </div>
        <div style={{ flex: 1, textAlign: "center" }}>
          <div style={{ fontSize: 22, fontWeight: 700, color: "#64b5f6" }}>
            {thisWeekAvg}
          </div>
          <div style={{ fontSize: 12, color: "#888", marginTop: 2 }}>📊 本周平均(分)</div>
        </div>
      </div>

      {/* 7-day heatmap */}
      <div style={{ marginBottom: 12 }}>
        <div style={{ fontSize: 12, color: "#666", marginBottom: 6 }}>7 天记录</div>
